...
# Walk code (adaptado por BR-NVS- da para andar pelo aero tambem)
...
var walk_about = func(wa_distance) {
   if (getprop("sim/current-view/view-number") == 0 or getprop("sim/current-view/view-number") == 8 or getprop("sim/current-view/view-number") == 11) {
